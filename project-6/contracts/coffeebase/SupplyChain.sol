...
contract SupplyChain is Ownable, FarmerRole , DistributorRole , RetailerRole , ConsumerRole{
  ...
  modifier verifyCaller (address _address) {
    require(msg.sender == _address, "Adresss not verified");
    _;
  }
  ...
  modifier harvested(uint _upc) {
    require(items[_upc].itemState == State.Harvested,"Illegal State: Harvested Expected");
    _;
  }
  ...
  onlyFarmer()
  {
   // Add the new item as part of Harvest
    items[_upc] = Item({sku : sku, upc : _upc, originFarmerID : _originFarmerID,
                      ...
                      distributorID: owner, retailerID: owner, consumerID: owner,
                      ownerID: owner, productID: _upc + sku});
    // Increment sku
     sku = sku + 1;
